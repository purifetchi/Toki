...
public class SigningTests
{
    ...
    private const string keyId = "https://keys-for-sale.example.com/key#public";
    ...
    [TestMethod]
    public void DigestsBodyAndSignsProperly()
    {
        const string truth = "keyId=\"https://keys-for-sale.example.com/key#public\",algorithm=\"rsa-sha256\",headers=\"(request-target) date digest host\",signature=\"\"";
        ...
        var signature = client!
            ...
            .AddHeaderToSign("Date", "Mon, 19 Feb 2024 17:56:13 GMT")
            .AddHeaderToSign("Digest", client.DigestMessage())
            .AddHeaderToSign("Host", "toki.dev.zone.lol")
            .ConstructSignature("POST", "/inbox");
