...
namespace Toki.ActivityPub.Migrations
{
    ...
    [Migration("20240401093304_Add pinned posts")]
    partial class Addpinnedposts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Toki.ActivityPub.Models.PinnedPost", b =>
                {
                    b.HasOne("Toki.ActivityPub.Models.Post", "Post")
                        .WithOne()
                        .HasForeignKey("Toki.ActivityPub.Models.PinnedPost", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Toki.ActivityPub.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("Toki.ActivityPub.Models.PinnedPost", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
